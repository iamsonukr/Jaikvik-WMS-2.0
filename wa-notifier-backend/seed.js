...
const demoUsers = [
  ...
  },
  {
    ...
    role: 'master', // runs campaigns/messaging for any client, manages tenants/plans/wallets
    tenantSlug: null,
...
const demoPlans = [
  {
    ...
    price: { monthly: 1299, quarterly: 3499, yearly: 11999 },
    currency: 'INR',
    taxPercent: 18,
    trialDays: 7,
    features: [
    ...
    messageRates: { marketing: 0.970, authentication: 0.129, utility: 0.160, service: 0 },
    status: 'active',
    displayOrder: 0,
    isPopular: false,
    showOnWebsite: true,
  ...
  },
  {
    ...
    price: { monthly: 2799, quarterly: 7699, yearly: 26999 },
    currency: 'INR',
    taxPercent: 18,
    trialDays: 7,
    features: [
    ...
    messageRates: { marketing: 0.958, authentication: 0.128, utility: 0.150, service: 0 },
    status: 'active',
    displayOrder: 1,
    isPopular: true,
    showOnWebsite: true,
  ...
  },
  {
    ...
    price: { monthly: 3899, quarterly: 10499, yearly: 36999 },
    currency: 'INR',
    taxPercent: 18,
    trialDays: 7,
    features: [
    ...
    messageRates: { marketing: 0.949, authentication: 0.127, utility: 0.140, service: 0 },
    status: 'active',
    displayOrder: 2,
    isPopular: false,
    showOnWebsite: true,
  ...
  },
  {
    ...
    customFields: null,
    tags: null,
    limits: { contacts: null, teamMembers: null, whatsappNumbers: null, customFields: null, tags: null },
    messageRates: { marketing: 0.949, authentication: 0.127, utility: 0.140, service: 0 },
    status: 'active',
    displayOrder: 3,
    isPopular: false,
