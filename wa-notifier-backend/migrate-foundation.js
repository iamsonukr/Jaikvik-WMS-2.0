...
const INITIAL_PLANS = [
  {
    ...
    taxPercent: 18,
    trialDays: 7,
    features: { bulkCampaigns: true, sharedInbox: true, greetingAutomation: true },
  ...
  },
  {
    ...
    trialDays: 7,
    features: {
      bulkCampaigns: true, sharedInbox: true, greetingAutomation: true,
      outOfOfficeAutomation: true, faqAutomation: true, chatbotFlows: true,
    },
  ...
  },
  {
    ...
    features: {
      bulkCampaigns: true, sharedInbox: true, greetingAutomation: true,
      outOfOfficeAutomation: true, faqAutomation: true, chatbotFlows: true,
      apiAccess: true, webhooks: true, catalogSupport: true, instagramAutomation: true,
      campaignSendingSpeed: 'fast',
    },
  ...
  },
  {
    ...
    trialDays: 0,
    features: {
      unlimitedAgents: true, unlimitedContacts: true, bulkCampaigns: true, sharedInbox: true,
      greetingAutomation: true, outOfOfficeAutomation: true, faqAutomation: true, chatbotFlows: true,
      apiAccess: true, webhooks: true, catalogSupport: true, instagramAutomation: true,
      dedicatedAccountManager: true, campaignSendingSpeed: 'fastest',
    },
    limits: {},
    status: 'active',
    displayOrder: 3,
