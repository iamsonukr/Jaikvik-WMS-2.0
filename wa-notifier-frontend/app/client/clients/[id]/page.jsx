...
export default function ClientDetailPage() {
  ...
  if (loading) return <AppShell allowedRoles={['client_owner','client_user']}><div className="flex justify-center py-20"><Spinner size={32} /></div></AppShell>;
  if (!client) return <AppShell allowedRoles={['client_owner','client_user']}><p className="text-[var(--muted-text)]">Client not found.</p></AppShell>;

  return (
    <AppShell allowedRoles={['client_owner','client_user']}>
      <div className="mb-6 flex items-center gap-3">
        <Link href="/client/clients"><Button variant="ghost" size="sm"><ArrowLeft size={14}/>Clients</Button></Link>
        <div>
