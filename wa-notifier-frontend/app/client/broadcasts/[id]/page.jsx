  ...
  if (error) {
    return (
      <AppShell allowedRoles={['client_owner','client_user']}>
        <div className="mb-6"><Link href="/client/broadcasts"><Button variant="ghost" size="sm"><ArrowLeft size={14}/>Back</Button></Link></div>
  ...
  return (
    <AppShell allowedRoles={['client_owner','client_user']}>
      <div className="mb-6 flex items-center gap-3">
        <Link href="/client/broadcasts"><Button variant="ghost" size="sm"><ArrowLeft size={14}/>Back</Button></Link>
        <div>
