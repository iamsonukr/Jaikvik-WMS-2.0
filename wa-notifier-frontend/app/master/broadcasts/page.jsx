  ...
  return (
    <AppShell allowedRoles={['admin', 'master']}>
      <PageHeader
        ...
        action={<Link href="/master/broadcasts/new"><Button><Plus size={15}/>New Campaign</Button></Link>}
      />
      ...
      {!loading && broadcasts.length === 0 && (
        <Empty icon={Megaphone} title="No campaigns yet" description="Create a broadcast to start sending template messages to your contacts." action={<Link href="/master/broadcasts/new"><Button><Plus size={14}/>New Campaign</Button></Link>} />
      )}
